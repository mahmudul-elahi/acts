...
return [
    ...
    */
    ...
    'webhook' => [
        ...
        'events' => [
            // Cashier's defaults keep the local subscription + payment data in sync.
            ...WebhookCommand::DEFAULT_EVENTS,
            // Fulfils one-time "Lifetime" purchases (see RecordLifetimePurchase).
            'checkout.session.completed',
            // Records failed renewals (see RecordStripePayment).
